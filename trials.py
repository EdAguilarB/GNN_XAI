...
def run():
    ...
    train_loader = DataLoader(torch.load("{}/train_loader.pth".format(exp_dir)).dataset[:30])
    test_loader = DataLoader(torch.load("{}/test_loader.pth".format(exp_dir)).dataset[:30])

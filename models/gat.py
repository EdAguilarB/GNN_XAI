...
class GAT(BaseNetwork):
    ...
    def __init__(self, opt: argparse.Namespace, n_node_features:int, n_edge_features:int):
        super().__init__(opt=opt, n_node_features=n_node_features, n_edge_features=n_edge_features)
